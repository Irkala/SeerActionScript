package com.robot.petFightModule.control
{
   ...
   public class PetFightController extends EventDispatcher
   {
      ...
      private var _npcChangePetIntervalID:uint = 0;
      ...
      private static function onGetPetInfo(param1:*) : void
      {
      ...
      public function destroy() : void
      {
         ...
         this.hashMap.clear();
         this.hashMap = null;
         if(this._npcChangePetIntervalID != 0)
         {
            clearInterval(this._npcChangePetIntervalID);
            this._npcChangePetIntervalID = 0;
         }
      ...
      private function onUseSkill(param1:*) : void
      {
      ...
      private function hasExistHandler(param1:*) : void
      {
      ...
      private function onUsePetItem(param1:*) : void
      {
      ...
      private function onCatchMonster(param1:*) : void
      {
         this.isUsingItem = true;
         var _loc2_:* = param1.data;
      ...
      private function onEscapeFight(param1:*) : void
      {
         this.isEscape = true;
      }
      
      private function onChangePet(param1:*) : void
      {
         ...
         if(_loc3_.userID == 0)
         {
            ...
            PetFightModel.defaultNpcID = _loc3_.petID;
         }
         else
         {
      ...
      private function execute(param1:Boolean = false) : void
      {
         ...
         else if(this.isReciveUseSkillCmd)
         {
            ...
            if(this.npcIsdied)
            {
               ...
               {
                  this._npcChangePetIntervalID = uint(setInterval(function():void
                  {
                     if(NpcChangePetData.npcPetChenged)
                     {
                        clearInterval(this._npcChangePetIntervalID);
      ...
      private function onUsePetItemOver(param1:*) : void
      {
