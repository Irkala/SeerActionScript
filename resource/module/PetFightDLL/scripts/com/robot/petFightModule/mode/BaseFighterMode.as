package com.robot.petFightModule.mode
{
   ...
   public class BaseFighterMode extends EventDispatcher
   {
      ...
      public function BaseFighterMode(param1:FightPetInfo, param2:Sprite)
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = getPetInfoByCatchTime(param1.catchTime);
         }
         this.skinId = _loc3_ != null ? _loc3_.skinID : 0;
         this.shiny = _loc3_ != null ? _loc3_.shiny : 0;
      ...
      private static function getPetInfoByCatchTime(param1:uint) : PetInfo
      {
         var _loc2_:Array = PetFightEntry._petInfoMap.getValues();
         var _loc3_:PetInfo = null;
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && _loc3_.catchTime == param1)
            {
               return _loc3_;
            }
         }
      ...
      public function createView(param1:Sprite) : void
      {
         ...
         this._petWin.update(this.petID,this.skinId != 0 ? this.skinId : this.petID,this.shiny);
      ...
      public function changePet(param1:ChangePetInfo) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = getPetInfoByCatchTime(param1.catchTime);
         }
         this.skinId = _loc2_ != null ? _loc2_.skinID : 0;
         this.shiny = _loc2_ != null ? _loc2_.shiny : 0;
         this.petName = PetXMLInfo.getName(this.petID);
         this.level = param1.level;
         this.hp = param1.hp;
         this.maxHP = param1.maxHp;
      ...
      public function useSkill(param1:AttackValue) : void
      {
         ...
         if(param1.state == 0)
         {
            this._petWin.applyShinyToMc(this._petWin.petMC);
         }
      }
      ...
      public function catchPet(param1:* = null) : void
      {
         if(!param1)
         {
