package com.robot.petFightModule.view
{
   ...
   public class BaseFighterPetWin extends Sprite
   {
      ...
      protected function setPetMC(param1:MovieClip) : void
      {
         ...
         if(this._shiny != 0)
         {
            var _shinyArr:Array = ShinyXMLInfo.getShinyArray(this.petID,this._shiny);
            var _colorFilter:ColorMatrixFilter = new ColorMatrixFilter(_shinyArr);
            var _glowArr:Array = ShinyXMLInfo.getGlowArray(this.petID,this._shiny);
            var _glowFilter:GlowFilter = new GlowFilter(uint(_glowArr[0]),int(_glowArr[1]),int(_glowArr[2]),int(_glowArr[3]),Number(_glowArr[4]));
            param1.filters = [this.filte,_glowFilter,_colorFilter];
         }
         else
         {
      ...
      public function catchSuccess(param1:*) : void
      {
         var data:* = null;
         ...
         setTimeout(function():void
         {
            ...
            {
               isBagFull = true;
               PetManager.addStorage(data.petID,data.catchTime,0,data.shiny);
            }
         },1500);
      ...
      public function update(param1:uint, param2:uint = 0, param3:uint = 0) : void
      {
         this.petID = param1;
         this._shiny = param3;
         var displayKey:int = param2 == 0 ? int(param1) : int(param2);
         var _loc4_:MovieClip = PetAssetsManager.getInstance().getAssetsByID(displayKey);
         this.setPetMC(_loc4_);
      }
      ...
      public function applyShinyToMc(param1:MovieClip) : void
      {
         if(param1 == null)
         {
            return;
