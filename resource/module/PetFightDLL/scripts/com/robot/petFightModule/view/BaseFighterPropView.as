package com.robot.petFightModule.view
{
   ...
   public class BaseFighterPropView
   {
      ...
      private function addPetPropIcon(param1:BaseFighterMode) : void
      {
         ...
         if(Boolean(_loc4_))
         {
            var _loc2_:Bitmap = DisplayUtil.copyDisplayAsBmp(_loc4_);
            _loc2_.x = 0;
            _loc2_.y = 0;
      ...
      protected function addIcon(param1:MovieClip) : void
      {
         ...
         var _loc4_:Point = this._propWin.parent.globalToLocal(this._propWin.localToGlobal(new Point(_loc2_,32)));
         param1.x = _loc4_.x;
         param1.y = _loc4_.y;
