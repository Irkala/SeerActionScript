package
{
   ...
   public dynamic class Timeline_3 extends MovieClip
   {
      ...
      {
         this.door_2.gotoAndStop(1);
      }
      
      internal function frame1() : *
      {
         this.door_2.addEventListener(MouseEvent.MOUSE_OVER,this.onOverHandler);
         this.door_2.addEventListener(MouseEvent.MOUSE_OUT,this.onOutHandler);
      }
      
      public function onOverHandler(param1:MouseEvent) : void
      {
         this.door_2.gotoAndStop(2);
      }
   }
}
