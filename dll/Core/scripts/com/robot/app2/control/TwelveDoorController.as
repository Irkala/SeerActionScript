package com.robot.app2.control
{
   ...
   import com.robot.core.MainManager;
   ...
   import com.robot.core.manager.ResourceManager;
   import com.robot.core.manager.map.config.BaseMapProcess;
   import com.robot.core.net.SocketConnection;
   import com.robot.core.ui.alert.Alarm;
   import com.robot.core.ui.alert.ItemInBagAlert;
   import com.robot.core.ui.alert.LinkToUrlManager;
   ...
   public class TwelveDoorController
   {
      ...
      private static function buyRevive() : void
      {
         ...
         {
            if(Boolean(ItemManager.getCollectionInfo(1700005)))
            {
      ...
      private static function onClickDoor(param1:Event) : void
      {
         ...
         {
            Alert.show("勇敢的XIN，你确定选择这扇门吗？如果选错了将传送进入其他层数哦！",function():void
            {
               goNextLevel(index);
            });
         });
      ...
      private static function onNextLevel(param1:SocketEvent) : void
      {
         ...
         var bmpData1:BitmapData = null;
         var ba:ByteArray = null;
         var bmpData2:BitmapData = null;
         var bmp:Bitmap = null;
         bmp = null;
         var e:SocketEvent = param1;
      ...
      public static function checkPreTimes(param1:BaseMapProcess) : void
      {
         ...
         _map = map;
         if(Boolean(MainManager.actorInfo.isVip))
         {
            return;
         }
