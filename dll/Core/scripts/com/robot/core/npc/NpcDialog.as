package com.robot.core.npc
{
   ...
   public class NpcDialog
   {
      ...
      public static function show(param1:uint, param2:Array, ... rest) : void
      {
         var param3:Array = rest.length > 0 ? rest[0] as Array : null;
         var param4:Array = rest.length > 1 ? rest[1] as Array : null;
         var _loc5_:int = 0;
