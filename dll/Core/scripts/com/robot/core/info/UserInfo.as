package com.robot.core.info
{
   ...
   public class UserInfo
   {
      ...
      public static function setForPeoleInfo(param1:UserInfo, param2:IDataInput) : void
      {
         ...
         param1.petShiny = param2.readUnsignedInt();
         ...
         while(_loc7_ < 32)
         {
            param1.nonoState.push(BitUtil.getBit(_loc6_,_loc7_));
            _loc7_++;
         }
         param1.nonoColor = param2.readUnsignedInt();
         param1.superNono = Boolean(param2.readUnsignedInt());
         param1.playerForm = Boolean(param2.readUnsignedInt());
      ...
      public static function setForLoginInfo(param1:UserInfo, param2:IDataInput) : void
      {
         ...
         param1.bufferRecordArr.length = 0;
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         while(_loc8_ < 200)
         {
            _loc9_ = int(param2.readByte());
            _loc10_ = 0;
            while(_loc10_ < 8)
            {
               param1.bufferRecordArr.push(BitUtil.getBit(_loc9_,_loc10_));
               _loc10_++;
            }
            _loc8_++;
         }
         ...
         param1.superNono = Boolean(param2.readUnsignedInt());
         var _loc12_:uint = param2.readUnsignedInt();
         var _loc13_:int = 0;
         while(_loc13_ < 32)
         {
            param1.nonoState.push(BitUtil.getBit(_loc12_,_loc13_));
            _loc13_++;
         }
         param1.nonoColor = param2.readUnsignedInt();
         ...
         param2.readBytes(_loc14_,0,27);
         param1.reserved = _loc14_;
         var _loc15_:int = 0;
         while(_loc15_ < 500)
         {
         ...
         var _loc16_:Array = TasksManager.taskList;
         ...
         var _loc17_:uint = param2.readUnsignedInt();
