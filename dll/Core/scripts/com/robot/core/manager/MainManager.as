package com.robot.core.manager
{
   ...
   public class MainManager
   {
      ...
      private static var _uiLoader2:MCLoader;
      ...
      private static const UI_PATH2:String = "resource/ui2.swf";
      ...
      private static function loaderUILib() : void
      {
         ...
         _uiLoader.doLoad();
         _uiLoader2 = new MCLoader(UI_PATH2,MainManager.getStage(),1,"正在加载星球");
         _uiLoader2.setIsShowClose(false);
         _uiLoader2.addEventListener(MCLoadEvent.SUCCESS,onLoadUI2);
         _uiLoader2.addEventListener(MCLoadEvent.ERROR,onFailLoadUI);
         _uiLoader2.doLoad();
      }
      ...
      private static function onLoadUI2(param1:MCLoadEvent) : void
      {
         UIManager2.setup(param1.getLoader());
      }
      ...
      public static function upDateForPeoleInfo(param1:UserInfo) : void
      {
         ...
         _actorInfo.spiritTime = param1.spiritTime;
         _actorInfo.spiritID = param1.spiritID;
         _actorInfo.petDV = param1.petDV;
         _actorInfo.petShiny = param1.petShiny;
         _actorInfo.petSkin = param1.petSkin;
         ...
         if(param1.clothes != null && param1.clothes.length > 0)
         {
            _actorInfo.clothes = param1.clothes.slice();
         }
         SystemTimerManager.setTime(_actorInfo.sysTime);
         if(PetManager.showInfo != null && PetManager.showInfo.catchTime == _actorInfo.spiritTime)
         {
            PetManager.showInfo.shiny = _actorInfo.petShiny;
         }
         if(_actorModel != null && _actorInfo.spiritID != 0)
         {
            _actorModel.refreshFollowPet();
         }
      }
