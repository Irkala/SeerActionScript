package com.robot.core.manager
{
   ...
   public class BufferRecordManager
   {
      ...
      {
         if(param1.bufferRecordArr == null || param2 >= param1.bufferRecordArr.length)
         {
            return false;
         }
         return Boolean(param1.bufferRecordArr[param2]);
      }
      ...
      private static function setBitStatge(param1:UserInfo, param2:uint, param3:Boolean, param4:uint, param5:Function = null) : void
      {
         ...
         if(_isSend)
         {
            ...
            _curInfo = param1;
            _curIndex = param2;
            SocketConnection.sendByQueue(CommandID.BUFFERRECORD,[param4,_curIndex,_curValue],onSetBufferComHandler);
            while(param1.bufferRecordArr.length <= param2)
            {
               param1.bufferRecordArr.push(false);
            }
            param1.bufferRecordArr[param2] = _curValue;
         }
      }
      ...
      {
         setState(MainManager.actorInfo,param1,param2,param3);
      }
      ...
      private static function setBitStatges(param1:UserInfo, param2:Array, param3:Array, param4:uint, param5:Function = null) : void
      {
         ...
         if(_isSend)
         {
            ...
            _loc7_.position = 0;
            SocketConnection.sendByQueue(CommandID.BUFFERRECORD,[_loc7_],onSetBufferComHandler);
            _loc8_ = 0;
            while(_loc8_ < param4)
            {
               while(param1.bufferRecordArr.length <= param2[_loc8_])
               {
                  param1.bufferRecordArr.push(false);
               }
               param1.bufferRecordArr[param2[_loc8_]] = param3[_loc8_];
               _loc8_++;
            }
         }
      }
