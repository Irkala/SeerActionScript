package com.robot.core.mode
{
   ...
   public class NpcModel extends BasePeoleModel
   {
      ...
      private var _npcHit:Sprite = this._npc;
      
      private var questionMark:MovieClip = AssetsManager.getMovieClip("lib_question_mark");
      
      private var excalMark:MovieClip = AssetsManager.getMovieClip("lib_excalmatory_mark");
      ...
      private var posList:Array = [new Point(280,291),new Point(420,340),new Point(611,427),new Point(200,500)];
      ...
      private function initNpc() : void
      {
         ...
         var _temp_3:* = _skeletonSys.getBodyMC();
         var _loc4_:Number;
         _skeletonSys.getBodyMC().scaleY = _loc4_ = 1.4;
         _temp_3.scaleX = false;
