package com.robot.core.mode
{
   ...
   public class OgreModel extends BobyModel
   {
      ...
      public function show(param1:uint, param2:Point, param3:uint = 0) : void
      {
         if(Boolean(this._obj))
         {
            return;
