package com.robot.core.mode
{
   ...
   public class BasePeoleModel extends BobyModel implements ISkeletonSprite
   {
      ...
      public var superNono:Boolean = false;
      ...
      public function BasePeoleModel(param1:UserInfo)
      {
         ...
         if(this._info.spiritID != 0)
         {
            ...
            _loc2_.shiny = this._info.petShiny;
      ...
      private function getMedal() : void
      {
         ...
         ResourceManager.getResource(_url,function(param1:DisplayObject):void
         {
            if(Boolean(param1))
            {
               ...
               addChild(_icon);
               var _loc2_:Rectangle = _icon.getBounds(_p);
      ...
      public function refreshFollowPet() : void
      {
         if(this._info == null || this._info.spiritID == 0)
         {
            return;
         }
      ...
      protected function addEvent() : void
      {
         ...
         this.clickBtn.addEventListener(MouseEvent.MOUSE_OVER,this.onRollOverHandler);
         this.clickBtn.addEventListener(MouseEvent.MOUSE_OUT,this.onRollOutHandler);
