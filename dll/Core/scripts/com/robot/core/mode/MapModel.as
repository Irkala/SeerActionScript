package com.robot.core.mode
{
   ...
   import com.robot.core.manager.map.MapLibManager2;
   ...
   public class MapModel implements IMapModel
   {
      ...
      private var _libManager:MapLibManager2 = new MapLibManager2();
      ...
      public function destroy() : void
      {
         ...
         this._loader.clear();
         this._loader = null;
         if(this._backLevel && this._backLevel.bitmapData)
         {
      ...
      public function get libManager() : MapLibManager2
      {
