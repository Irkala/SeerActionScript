package com.robot.core.mode
{
   ...
   public class GalaxyModal extends EventDispatcher
   {
      ...
      public function GalaxyModal(param1:String, param2:uint, param3:String)
      {
         super();
         this._url = param1;
         this._title = param3;
         this.cls = getDefinitionByName("com.robot.app.galaxy.Galaxy_" + param2) as Class;
      }
      ...
      private function onLoad(param1:MCLoadEvent) : void
      {
         ...
         this._mode = new this.cls();
         this._mode.setup(param1.getLoader());
         if(this._data != null)
         {
