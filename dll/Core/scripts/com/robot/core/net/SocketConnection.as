package com.robot.core.net
{
   ...
   public class SocketConnection
   {
      ...
      public static function sendByQueue(param1:uint, param2:Array, param3:Function = null, param4:Function = null) : void
      {
         var _onComplete:Function = null;
         if(param3 != null)
         {
            _onComplete = function(event:SocketEvent):void
            {
               SocketConnection.removeCmdListener(param1,_onComplete);
               param3(event);
            };
            SocketConnection.addCmdListener(param1,_onComplete);
         }
         SocketConnection.send.apply(null,[param1].concat(param2));
      }
