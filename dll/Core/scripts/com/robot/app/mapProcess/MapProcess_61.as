package com.robot.app.mapProcess
{
   ...
   import com.robot.app2.mapProcess.control.EarlSerraController;
   ...
   public class MapProcess_61 extends BaseMapProcess
   {
      ...
      private static const CMD_GAIYA_EFFECT:uint = 2149;
      ...
      override protected function init() : void
      {
         ...
         EarlSerraController.initMap(this);
         if(MainManager.actorPrevState == 2)
         {
      ...
      private function onTimerHandler(param1:SysTimeEvent) : void
      {
         ...
         this._lightBossMc = mapModel.libManager.getMovieClip("LightBoss_Mc");
      ...
      private function onBossClickHandler(param1:MouseEvent) : void
      {
         if(MapManager.currentMap.id == 61)
         {
            ...
            {
               SocketConnection.addCmdListener(CMD_GAIYA_EFFECT,this.onGaiyaEffect);
               SocketConnection.send(CMD_GAIYA_EFFECT);
            }
            else
            {
      ...
      private function onGaiyaFightWin(param1:Event) : void
      {
         ...
         SocketConnection.addCmdListener(CMD_GAIYA_EFFECT,this.onGaiyaEffectEnd);
         SocketConnection.send(CMD_GAIYA_EFFECT);
      }
      
      private function onGaiyaEffectEnd(param1:SocketEvent) : void
      {
         SocketConnection.removeCmdListener(CMD_GAIYA_EFFECT,this.onGaiyaEffectEnd);
         var _loc2_:GaiyaEffectInfo = param1.data as GaiyaEffectInfo;
         if(_loc2_ == null)
         {
            _loc2_ = new GaiyaEffectInfo(param1.data as IDataInput);
         }
         if(_loc2_ == null || _loc2_.effects == null)
         {
            return;
         }
      ...
      {
         SocketConnection.removeCmdListener(CMD_GAIYA_EFFECT,this.onGaiyaEffect);
         var _loc2_:GaiyaEffectInfo = param1.data as GaiyaEffectInfo;
         if(_loc2_ == null)
         {
            _loc2_ = new GaiyaEffectInfo(param1.data as IDataInput);
      ...
      private function gaiyaDialog_1() : void
      {
         NpcDialog.show(NPC.EERSAILA,["你来找我有什么事？等等……这是什么？好浓郁的黑暗气息！ "],null,null,false,function():void
         {
            ...
            {
               var mapModel2:* = MapManager.currentMap;
               if(!mapModel2 || !("libManager" in mapModel2) || !mapModel2["libManager"])
               {
                  return;
               }
               _gaiyadonghua = mapModel2.libManager.getMovieClip("gaiyaXieqi");
               _gaiyadonghua.x = 439;
               _gaiyadonghua.y = 464;
            }
