package com.robot.app.mapProcess
{
   ...
   public class MapProcess_404 extends BaseMapProcess
   {
      ...
      private function configModel(param1:Number, param2:Number) : void
      {
         ...
         for each(var _loc3_ in UserManager.getUserModelList())
         {
         }
      }
      ...
      {
         var _temp_1:* = MainManager.actorModel;
         MainManager.actorModel.scaleY = 1;
         _temp_1.scaleX = 1;
         if(Boolean(MainManager.actorModel.pet))
         {
            var _temp_2:* = MainManager.actorModel.pet;
            var _loc1_:int;
            MainManager.actorModel.pet.scaleY = _loc1_ = 1;
            _temp_2.scaleX = 1;
         }
