   ...
   public class MapProcess_512 extends BaseMapProcess
   {
      ...
      public function clickLineBelt() : void
      {
         ...
         if(Boolean(_loc2_))
         {
            ...
            ResourceManager.getResource(ClientConfig.getPetSwfPath(_loc2_.info.petID,_loc2_.info.catchTime),this.onShowComplete1,"pet");
         }
         else
         {
      ...
      private function onLoadDLL(param1:MCLoadEvent) : void
      {
         ...
         var _loc3_:SimpleButton = Sprite(_loc2_.getChildAt(0)).getChildAt(4)["close_btn"];
         this.helpMC = Sprite(_loc2_.getChildAt(0)).getChildAt(5) as MovieClip;
         _loc3_.addEventListener(MouseEvent.CLICK,this.extCloseHandler);
      }
      
      private function extCloseHandler(param1:MouseEvent) : void
      {
      ...
      private function onGameOver(param1:Event) : void
      {
         ...
         var _loc4_:int = int((_loc2_ - 1) / 2 * 10) * 10;
