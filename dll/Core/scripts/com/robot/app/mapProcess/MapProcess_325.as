package com.robot.app.mapProcess
{
   ...
   public class MapProcess_325 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         shortTree = conLevel["shortTree"];
         if(shortTree)
         {
            shortTree.gotoAndStop(1);
         }
         ...
         if(TasksManager.getTaskStatus(97) == TasksManager.ALR_ACCEPT && this.npcPet)
         {
         ...
         if(TasksManager.getTaskStatus(97) == TasksManager.COMPLETE && this.npcPet)
         {
      ...
      {
         if(Boolean(conLevel["overTaskShow"]))
         {
      ...
      private function isPlayMusic(param1:uint) : void
      {
         ...
         if(this.musicIDArr[this.musicNum] == n)
         {
            ...
            if(this.musicNum == 3)
            {
               if(this.isInTask && Boolean(depthLevel["jellyseer_mc"]))
               {
                  this.musicNum = 0;
      ...
      private function musicPlay(param1:MouseEvent) : void
      {
         ...
         TasksManager.getProStatusList(97,function(param1:Array):void
         {
            ...
            if(Boolean(arr[1]) && !arr[2])
            {
               if(oneString != "click" && k == 4 && Boolean(conLevel["music4"]))
               {
      ...
      {
         if(!Boolean(depthLevel["jellyseer_mc"]))
         {
            return;
         }
