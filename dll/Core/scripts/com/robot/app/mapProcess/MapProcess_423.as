package com.robot.app.mapProcess
{
   ...
   public class MapProcess_423 extends BaseMapProcess
   {
      ...
      {
         var peoplesGaiyaActionControllerClass:Class;
         SocketConnection.send(1022,86066231);
         peoplesGaiyaActionControllerClass = null;
         try
         {
            peoplesGaiyaActionControllerClass = getDefinitionByName("com.robot.app2.control.PeoplesGaiyaActionController") as Class;
         }
         catch(e:ReferenceError)
         {
         }
         if(peoplesGaiyaActionControllerClass && "init" in peoplesGaiyaActionControllerClass)
         {
            peoplesGaiyaActionControllerClass["init"](this);
         }
      ...
      {
         DisplayUtil.removeForParent(animatorLevel["sptBoss"]);
         var mapModel:* = MapManager.currentMap;
         if(!mapModel || !("libManager" in mapModel) || !mapModel["libManager"])
         {
            return;
         }
         if(this._animation_gaiya == null)
         {
            this._animation_gaiya = mapModel.libManager.getMovieClip("animation_gaiya");
      ...
      private function showLeiyi() : void
      {
         ...
         this._animation_leiyi = mapModel.libManager.getMovieClip("animation_leiyi");
      ...
      private function animationGaiya_1() : void
      {
         ...
         mapModel1 = MapManager.currentMap;
         if(mapModel1 && "libManager" in mapModel1 && mapModel1["libManager"])
         {
            mapModel1.libManager.getSound("sound_gaiya_hou").play();
         }
      }
      ...
      private function gaiyaDialog_1() : void
      {
         ...
         {
            NpcDialog.show(NPC.LAOKE_LEIDE,["很好，就是需要这种气势！好了，废话不多说，我们切入真题！哼哼，先让你了解一下什么是领域吧！"],["好的"],[function():void
            {
               var mapModel2:*;
               var guang:* = undefined;
               LevelManager.closeMouseEvent();
               ...
               guang.gotoAndPlay(1);
               mapModel2 = MapManager.currentMap;
               if(mapModel2 && "libManager" in mapModel2 && mapModel2["libManager"])
               {
                  mapModel2.libManager.getSound("sound_gaiya_minxiang").play();
               }
            }]);
         }]);
      }
      ...
      {
         NpcDialog.show(NPC.GAIYA,["为什么……为什么是他，为什么我会看到雷伊！"],["......"],[function():void
         {
            NpcDialog.show(NPC.LAOKE_LEIDE,["这是我的领域规则，在这里，你会看到你最在意或是最害怕的东西……哼哼，这就是你的心魔！你在害怕，你怕雷伊会越来越强，和你的距离越来越远，对吗？"],["......"],[function():void
            {
               NpcDialog.show(NPC.GAIYA,["心魔？也许是吧……不！这绝不是我所希望看到的，我要超越他，超越他！！"],["......"],[function():void
               {
      ...
      private function animationGaiyaXie_1() : void
      {
         ...
         this._animation_gaiya.gotoAndPlay(1);
         mapModel3 = MapManager.currentMap;
         if(mapModel3 && "libManager" in mapModel3 && mapModel3["libManager"])
         {
            mapModel3.libManager.getSound("sound_gaiya_hou").play();
         }
      }
      ...
      private function animationGaiyaShi_1() : void
      {
         ...
         this._animation_gaiya.gotoAndPlay(1);
         mapModel4 = MapManager.currentMap;
         if(mapModel4 && "libManager" in mapModel4 && mapModel4["libManager"])
         {
            mapModel4.libManager.getSound("sound_gaiya_hou").play();
         }
      }
      ...
      {
         var mapModel5:* = MapManager.currentMap;
         if(!mapModel5 || !("libManager" in mapModel5) || !mapModel5["libManager"])
         {
            return;
         }
         this._animation_hamoleite = mapModel5.libManager.getMovieClip("animation_hamoleite");
      ...
      private function initSPTBoss() : void
      {
         ...
         if(this._stoneBtn)
         {
            this._stoneBtn.addEventListener(MouseEvent.CLICK,this.onStoneTipSimple);
      ...
      private function destroySPT() : void
      {
         if(this._stoneBtn)
         {
            this._stoneBtn.removeEventListener(MouseEvent.CLICK,this.onStoneTipSimple);
            this._stoneBtn = null;
         }
         if(this._sptBtn)
         {
      ...
      private function onStoneTipSimple(param1:MouseEvent) : void
      {
         Alarm.show("规则掌控者活动说明暂未实现，但挑战功能可正常使用。");
      }
      ...
      private function onSptHandler(param1:MouseEvent) : void
      {
         ...
         var minutes:uint = uint(date.getMinutes());
         if(minutes < 21)
         {
            this._sptType = 0;
      ...
      override public function destroy() : void
      {
         ...
         if(peoplesGaiyaActionControllerClass && "destroy" in peoplesGaiyaActionControllerClass)
         {
            peoplesGaiyaActionControllerClass["destroy"]();
         }
         Task618.destroy();
         ToolTipManager.remove(conLevel["gaiyaTrain"]);
         conLevel["gaiyaTrain"].removeEventListener(MouseEvent.CLICK,this.onTrainClick);
