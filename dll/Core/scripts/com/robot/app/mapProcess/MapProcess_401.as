package com.robot.app.mapProcess
{
   ...
   public class MapProcess_401 extends BaseMapProcess
   {
      ...
      private var _guardianIndex:int = 0;
      ...
      private function initComp1(param1:PetFightEvent) : void
      {
         ...
         NpcDialog.show(NPC.XUANWU,["你的表现令我震惊，你愿意接受最后的考验吗？"],["我愿意接受最后的考验。","我还是下次再来吧。"],[this.initComp1Helper,this.exitToPrevMap]);
      }
      
      private function exitToPrevMap() : void
      {
         var i:int = 0;
         var pet:MovieClip = null;
         index = 0;
            ...
            Task142.getMc(pet,2,"",function(param1:MovieClip):void
            {
               ...
               AnimateManager.playMcAnimate(mc,0,"",function():void
               {
                  ...
                  if(index == 6)
                  {
                     ...
                     {
                        var bossMc:MovieClip = param1;
                        AnimateManager.playMcAnimate(bossMc,0,"",function():void
                        {
                           stopMC(bossMc.parent);
      ...
      private function fightXuanWu(param1:MouseEvent) : void
      {
         ...
         FightInviteManager.fightWithBoss("巴斯特",6,true);
      }
