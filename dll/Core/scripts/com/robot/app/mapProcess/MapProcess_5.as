package com.robot.app.mapProcess
{
   ...
   public class MapProcess_5 extends BaseMapProcess
   {
      ...
      override public function destroy() : void
      {
         ...
         {
            SocketConnection.removeCmdListener(CommandID.PET_COLLECT,this.onPetCollectResp);
      ...
      private function onCheckSuccessHandler(param1:SocketEvent) : void
      {
         ...
         try
         {
            if(_loc2_ && _loc2_.bytesAvailable >= 8)
            {
      ...
      private function show() : void
      {
         ...
         SocketConnection.removeCmdListener(CommandID.PET_COLLECT,this.onPetCollectResp);
         SocketConnection.addCmdListener(CommandID.PET_COLLECT,this.onPetCollectResp);
      }
      
      private function onPetCollectResp(param1:SocketEvent) : void
      {
         var _loc2_:ByteArray = param1.data as ByteArray;
         if(_loc2_ == null || _loc2_.bytesAvailable < 4)
         {
            return;
         }
