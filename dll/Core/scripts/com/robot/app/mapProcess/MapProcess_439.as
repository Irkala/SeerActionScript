package com.robot.app.mapProcess
{
   ...
   public class MapProcess_439 extends BaseMapProcess
   {
      ...
      {
         if("arrow" in conLevel && conLevel["arrow"])
         {
            conLevel["arrow"].visible = false;
         }
         if("door_0" in conLevel && conLevel["door_0"])
         {
            conLevel["door_0"].visible = false;
         }
         if("foot_1" in conLevel && conLevel["foot_1"])
         {
         ...
         if("foot_2" in conLevel && conLevel["foot_2"])
         {
         ...
         if("light_1" in conLevel && conLevel["light_1"])
         {
         ...
         if("light_2" in conLevel && conLevel["light_2"])
         {
