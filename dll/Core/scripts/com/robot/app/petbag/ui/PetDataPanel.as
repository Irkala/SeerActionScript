package com.robot.app.petbag.ui
{
   ...
   import com.robot.core.manager.UIManager2;
   ...
   public class PetDataPanel
   {
      ...
      private static var filte:GlowFilter = new GlowFilter(3355443,0.9,3,3,3.1);
      ...
      public function clearInfo() : void
      {
         ...
         if(Boolean(this._specialEffectIcon))
         {
      ...
      public function show(param1:PetInfo) : void
      {
         ...
         {
            SocketConnection.addCmdListener(0,this.onGaiyaEffect);
      ...
      private function onShowComplete(param1:DisplayObject) : void
      {
         ...
         if(Boolean(this._showMc))
         {
            ...
            this._showMc.x = 70;
            this._showMc.y = 110;
            if(Boolean(this._petInfo) && this._petInfo.shiny != 0)
            {
               var _shinyArr:Array = ShinyXMLInfo.getShinyArray(this._petInfo.id,this._petInfo.shiny);
               var _colorFilter:ColorMatrixFilter = new ColorMatrixFilter(_shinyArr);
               var _glowArr:Array = ShinyXMLInfo.getGlowArray(this._petInfo.id,this._petInfo.shiny);
               var _glowFilter:GlowFilter = new GlowFilter(uint(_glowArr[0]),int(_glowArr[1]),int(_glowArr[2]),int(_glowArr[3]),Number(_glowArr[4]));
               this._showMc.filters = [filte,_glowFilter,_colorFilter];
            }
      ...
      private function onGaiyaEffect(param1:SocketEvent) : void
      {
         ...
         var info:GaiyaEffectInfo = null;
         SocketConnection.removeCmdListener(0,this.onGaiyaEffect);
         info = param1.data as GaiyaEffectInfo;
         if(info == null)
         {
            try
            {
               bytes = param1.data as ByteArray;
               if(bytes)
               {
                  bytes.position = 0;
         ...
         {
            this._specialEffectIcon = UIManager2.getSprite("icon_gaiya_shixuezhili");
         ...
         {
            this._specialEffectIcon = UIManager2.getSprite("icon_gaiya_xieqilingran");
            if(this._specialEffectIcon)
            {
         ...
         {
            this._specialEffectIcon = UIManager2.getSprite("icon_gaiya_shipotianjing");
            if(this._specialEffectIcon)
            {
