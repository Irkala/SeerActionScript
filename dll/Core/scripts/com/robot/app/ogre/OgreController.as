package com.robot.app.ogre
{
   ...
   public class OgreController
   {
      ...
      public static function add(param1:int, param2:uint, param3:uint = 0) : void
      {
         if(_isSwitching)
         {
            return;
         ...
         if(Boolean(_pList))
         {
            var _loc4_:OgreModel = _list.getValue(param1) as OgreModel;
            if(Boolean(_loc4_))
            {
               _loc4_.removeEventListener(RobotEvent.OGRE_CLICK,onClick);
               _loc4_.destroy();
               _loc4_ = null;
            }
            _loc4_ = new OgreModel(param1);
            ...
            _loc4_.addEventListener(RobotEvent.OGRE_CLICK,onClick);
            _list.add(param1,_loc4_);
            _loc4_.show(param2,_pList[param1],param3);
         }
      }
