package com.robot.app.worldMap
{
   ...
   import com.robot.core.mode.GalaxyModal;
   ...
   public class WorldMapPanel extends Sprite
   {
      ...
      private var subPanel:GalaxyModal;
      ...
      private function initGalaxy() : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            if(Boolean(_loc1_))
            {
               ...
               {
                  var _loc2_:* = uint(_loc1_.name.split("_")[1]);
      ...
      {
         this.subPanel = new GalaxyModal(ClientConfig.getAppModule("subMap/Galaxy_" + param1),param1,"正在进入" + GalaxyXMLInfo.getName(param1));
