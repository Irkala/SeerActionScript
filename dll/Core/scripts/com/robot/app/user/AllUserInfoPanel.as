      ...
      private function addBossIcon(param1:Array = null) : void
      {
         ...
         while(_loc3_ < this.allBossNum_uint)
         {
            ...
            else
            {
               ...
               _loc2_.y = 2;
               var _achieved:Boolean = this.userInfo.bossAchievement != null && _loc3_ < this.userInfo.bossAchievement.length && this.userInfo.bossAchievement[_loc3_] == true;
               if(_achieved && _loc2_["mc1"] != null)
               {
                  _loc2_["mc1"].visible = false;
               }
               if(_loc2_["win_mc"] != null)
               {
