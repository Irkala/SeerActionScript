package com.robot.app.task.taskscollection
{
   ...
   public class Task558
   {
      ...
      public static function initTask_459(param1:BaseMapProcess) : void
      {
         ...
         else if(TasksManager.getTaskStatus(TaskController_558.TASK_ID) == TasksManager.ALR_ACCEPT)
         {
            ...
            TasksManager.getProStatusList(TaskController_558.TASK_ID,function(param1:Array):void
            {
               ...
               {
                  NpcDialog.show(NPC.SMALL_PET,["不行！我绝对不能轻举妄动！先去告诉爱丽丝吧！那两个精灵绝对不简单……"],["快返回赛尔号"],[function():void
                  {
      ...
      private static function addFlowerEvent() : void
      {
         ...
         while(i1 < 4)
         {
            mc = _map.conLevel["flowerMc" + i1] as MovieClip;
            mc.addEventListener(MouseEvent.CLICK,onFlowerClickHandler);
            i1++;
         }
      }
      ...
      private static function onDownFenHandler(param1:MouseEvent) : void
      {
         ...
         var targetMc:MovieClip = param1.currentTarget as MovieClip;
         if(targetMc)
         {
            idStr = targetMc.name.slice(5,6);
            fMc = _map.conLevel["fenMc" + idStr] as MovieClip;
         }
      }
         ...
         if(petMc0.hitTestObject(fMc))
         {
            ...
            AnimateManager.playMcAnimate(petMc0,2,"ani",function():void
            {
               ...
               AnimateManager.playMcAnimate(petMc1,2,"ani",function():void
               {
                  ...
                  while(i2 < 4)
                  {
                     mcInside = chongMc["ani" + i2] as MovieClip;
                     mcInside.mouseChildren = false;
                     if(i2 != 1)
                     {
                        mcInside.gotoAndStop(1);
      ...
      {
         var mc:MovieClip = chongMc["ani" + chongHold] as MovieClip;
         if(mc.currentFrame == mc.totalFrames)
         {
            ...
            mc = chongMc["ani" + chongHold] as MovieClip;
            mc.gotoAndPlay(1);
            mc.visible = true;
         }
      }
