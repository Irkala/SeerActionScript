package com.robot.app.task.taskUtils.manage
{
   ...
   public class StoryLoaderManager
   {
      ...
      private static var _instance:StoryLoaderManager;
      ...
      public static function get insatnce() : StoryLoaderManager
      {
         return _instance = _instance || new StoryLoaderManager();
      }
