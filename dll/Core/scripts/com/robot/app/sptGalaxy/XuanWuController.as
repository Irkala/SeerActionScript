package com.robot.app.sptGalaxy
{
   ...
   public class XuanWuController
   {
      ...
      private static var _pos:Array = [[550,450],[650,450],[430,300],[500,320],[280,200],[460,410],[430,450],[490,440],[480,400],[490,190]];
      ...
      private static function onMapOpenHandler(param1:MapEvent) : void
      {
         ...
         {
            if(SystemTimerManager.sysDate.getMinutes() >= 50)
            {
