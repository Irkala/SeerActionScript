package com.robot.module.game.plantsVsZombies.shotBehavior
{
   ...
   public class Shot_1 extends BaseShotBehavior implements IShotBehavior
   {
      
      public function Shot_1(sprite:BaseShotSprite, attack:Number)
      {
         super(sprite,attack);
         offSet = new Point(54,-29);
      }
      
      override protected function getMC() : MovieClip
      {
         return new plants_shot_mc_1();
      }
