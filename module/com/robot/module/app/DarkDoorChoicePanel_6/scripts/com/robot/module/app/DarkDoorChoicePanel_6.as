package com.robot.module.app
{
   ...
   public class DarkDoorChoicePanel_6 extends Sprite implements IModule
   {
      ...
      private var _mainPanel:DarkProtalDoorMc6;
      ...
      public function DarkDoorChoicePanel_6()
      {
         super();
      }
      ...
      {
         this._mainPanel = new DarkProtalDoorMc6();
      ...
      private function onSureBtnClickHandler(e:MouseEvent) : void
      {
         ...
         DarkPortalModel.enterDarkProtal(36 + this._curIndex,this.hide,this._curIndex);
      }
