package com.robot.module.app
{
   ...
   public class DarkDoorChoicePanel_9 extends Sprite implements IModule
   {
      ...
      public function DarkDoorChoicePanel_9()
      {
         super();
      }
      ...
      {
         this._mainPanel = new DarkProtalDoorMc9();
      ...
      private function onSureBtn(e:MouseEvent) : void
      {
         ...
         DarkPortalModel.enterDarkProtal(54 + this._currentIndex,this.hide,this._currentIndex);
      }
