package com.robot.module.app
{
   ...
   public class DarkDoorChoicePanel_5 extends Sprite implements IModule
   {
      ...
      private var _mainPanel:DarkProtalDoorMc5;
      ...
      public function DarkDoorChoicePanel_5()
      {
         super();
      }
      ...
      {
         this._mainPanel = new DarkProtalDoorMc5();
      ...
      private function onSureBtnClickHandler(e:MouseEvent) : void
      {
         ...
         DarkPortalModel.enterDarkProtal(30 + this._curIndex,this.hide,this._curIndex);
      }
