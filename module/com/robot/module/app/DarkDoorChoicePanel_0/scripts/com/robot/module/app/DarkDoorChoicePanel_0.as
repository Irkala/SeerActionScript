package com.robot.module.app
{
   ...
   public class DarkDoorChoicePanel_0 extends Sprite implements IModule
   {
      
      private var _mainPanel:DarkProtalDoorMc0;
      ...
      private var _point:Point = new Point(406.85,32.2);
      
      public function DarkDoorChoicePanel_0()
      {
         super();
      }
      ...
      {
         this._mainPanel = new DarkProtalDoorMc0();
      ...
      private function onSureClickHandler(e:MouseEvent) : void
      {
         ...
         DarkPortalModel.enterDarkProtal(0,this.hide);
      }
