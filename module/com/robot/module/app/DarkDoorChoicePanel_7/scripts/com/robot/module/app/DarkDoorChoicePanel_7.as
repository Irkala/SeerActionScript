package com.robot.module.app
{
   ...
   public class DarkDoorChoicePanel_7 extends Sprite implements IModule
   {
      ...
      public function DarkDoorChoicePanel_7()
      {
         super();
      }
      ...
      {
         this._mainPanel = new DarkProtalDoorMc7();
      ...
      private function onSureBtn(e:MouseEvent) : void
      {
         ...
         DarkPortalModel.enterDarkProtal(42 + this._currentIndex,this.hide,this._currentIndex);
      }
