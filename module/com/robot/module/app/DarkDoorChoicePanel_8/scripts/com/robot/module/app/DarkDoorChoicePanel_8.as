package com.robot.module.app
{
   ...
   public class DarkDoorChoicePanel_8 extends Sprite implements IModule
   {
      ...
      public function DarkDoorChoicePanel_8()
      {
         super();
      }
      ...
      {
         this._mainPanel = new DarkProtalDoorMc8();
      ...
      private function onSureBtn(e:MouseEvent) : void
      {
         ...
         DarkPortalModel.enterDarkProtal(48 + this._currentIndex,this.hide,this._currentIndex);
      }
