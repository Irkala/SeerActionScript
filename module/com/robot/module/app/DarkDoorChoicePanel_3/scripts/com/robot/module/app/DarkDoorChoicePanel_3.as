package com.robot.module.app
{
   ...
   public class DarkDoorChoicePanel_3 extends Sprite implements IModule
   {
      
      private var _mainPanel:DarkProtalDoorMc3;
      ...
      private var _point:Point = new Point(584.7,17.65);
      
      private var glowF:GlowFilter;
      
      private var doorIndex:uint = 0;
      
      public function DarkDoorChoicePanel_3()
      {
         super();
      }
      ...
      {
         this._mainPanel = new DarkProtalDoorMc3();
      ...
      private function onFrameEventHandler(e:Event) : void
      {
         ...
         if(Boolean(this._doorContainer))
         {
      ...
      private function onSureClickHandler(e:MouseEvent) : void
      {
         ...
         {
            case 1:
               DarkPortalModel.enterDarkProtal(18,this.hide,this.doorIndex);
               break;
            case 2:
               DarkPortalModel.enterDarkProtal(19,this.hide,this.doorIndex);
         }
      }
